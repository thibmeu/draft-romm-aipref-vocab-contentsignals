...
Discussion of this work occurs on the [AI Preferences
Working Group mailing list](mailto:ai-control@ietf.org)
([archive](https://mailarchive.ietf.org/arch/browse/ai-control/),
[subscribe](https://mailman3.ietf.org/mailman3/lists/ai-control.ietf.org/)).
...
[Working Group documents](https://datatracker.ietf.org/wg/aipref/documents/).
